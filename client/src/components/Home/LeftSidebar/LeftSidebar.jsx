...
export default function LeftSidebar({
  ...
  return (
    <div
      className={`w-3/4 md:w-1/2 fixed bg-slate-100 md:bg-transparent md:sticky top-0 md:top-4 left-0 h-full md:h-fit transition-all md:translate-x-0 z-10 overflow-y-scroll md:overflow-y-hidden ${
        !mobileSidebarView ? "-translate-x-full" : "translate-x-0"
      }`}
    >
      <div className="bg-slate-100 md:rounded-md shadow-md p-4">
      ...
      <div className="text-black bg-slate-200 md:bg-transparent px-2 md:px-0 py-2 md:py-2">
        Designed and developed by{" "}
        <a
          className="font-bold"
          href="https://shahidulalamcse.com"
          target="_blank"
          rel="noreferrer"
        >
          Shahidul Alam
